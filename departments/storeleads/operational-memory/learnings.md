...
- **▶ NEXT SESSION:** continue Nursery tail — `sl_select_all` (now excludes b1–8) for batches 9+ (visits <113, ~2,000 left, then **MISSING-visits stores LAST** — kept, RULE 24). Full Nursery exhaust ≈ 16 more batches. Remaining ≈ 4621. Prep more pre-enriched reservoir batches ahead (token-free) so each post-compact segment starts instantly.
