# ShopHunter — Founder Feedback (Marina's decisions & calibration)

Parallels the FB department's founder-feedback. Records Marina's exact Founder Review decisions on
ShopHunter-sourced products + the calibration signals distilled from them. The canonical decision lives in
the Notion **Founder Review** field; this file is the durable calibration memory for future ShopHunter sessions.
Agent never invents decisions — only records what Marina explicitly sets.
...
| Product | Founder Review | Founder Notes | Rejection Reason |
|---|---|---|---|
| **OroMilk One-Touch** (nut/plant-milk maker) | ✅ **Approved** | Strong health trend. Stylish and modern. | — |
| TempMaster Warming Mat | 🟡 Consider | Stylish pain-solver. Strong comfort angle. | — |
