...
## Priority Queue — Sessions 15–20 Broad Horizontal Discovery [ЗАКРЫТА — АРХИВИРОВАНА S30]

> ⛔ Hypothesis CLOSED after Session 20 (29 keywords → 2 reportable, both S15). Performance signal keywords do NOT filter for DTC physical operators.
> Full 30-keyword planning table + Kids-vertical on-hold list moved to `archive/keyword-map-archived-S15-20-queue.md` (S30 cleanup).
> All keyword verdicts are preserved in the live Keyword Scorecard table above. Do NOT reopen.
...
| Situation | train ride | S30 | 502 | ❌ DEAD | Ambiguous-CONTEXT phrase → 3 unrelated literal senses: scenic-railroad tourism (museums/railroads, dominant) + athletic "training" (cycling/MTB/dressage/motorcycle) + truck "train horns"; zero white-label commuter-comfort DTC; 0 |
↳ Noise Type: scenic-railroad tourism | athletic training (cycling/MTB/motorcycle/dressage) | truck train-horns (commodity) | e-bikes (branded) | apparel | holsters (Meta-policy) | ↳ Emotional Cluster: travel-nostalgia / fitness / novelty (split, no coherent moment) | ↳ Signal Density: Very Low (<2% white-label) | ↳ Recurring Categories: compact "no-air-tank" train horns (Norbbshop/HornBlasters/MotoHorn — off-theme), bike saddles
| Situation/WFH | kitchen table office | S30 | 569 | ❌ DEAD | Domestic-lifestyle phrase = pharma "doctor-story" NO-DOMAIN spam magnet; expected WFH ergonomic objects (lap desk/foldable desk/desk converter/monitor riser) had ZERO advertisers — same "expected-object-absent" pattern as S29 "working from bed"; 0 |
↳ Noise Type: pharma "doctor-story" NO-DOMAIN spam (hearing/lutein/BP/menopause/ADHD/impotence, 10+) | novel/story-spam | Temu/Alibaba commodity | mobility power-chairs | office-space-rental/coaching services | ↳ Emotional Cluster: WFH-at-home / health-fear narratives | ↳ Signal Density: Very Low (<2%) | ↳ Recurring Categories: none (WFH-furniture absent)
| Situation/Travel | pack for a work trip | S30 | 518 | ✅ USE | Rhona TravelVac Pro 74 (cordless 4500Pa vacuum compression + 3 bags); concrete prep-moment → real travel-gadget DTC; vacuum-compression travel cluster 4+ advertisers (Rhona + Luux VacPack $79 + The Foldie + compression cubes); Luux 2-in-1 garment duffle ~63 sub-threshold |
↳ Noise Type: branded discount-anchor bag brands (Veria 60%-off) | multi-product fishing dropship (Colitt) | packing-cube commodity (Eagle Creek) | pharma-story-spam bleed | Alibaba/Temu B2B | ↳ Emotional Cluster: overpacking stress / carry-on space / avoid bag fees | ↳ Signal Density: Medium (~10% white-label travel gadgets) | ↳ Recurring Categories: cordless vacuum compression (Rhona/Luux VacPack/Foldie), compression cubes, travel garment duffles, travel item-trackers
| Office×Pet | cat on desk | S30 | 552 | ✅ USE | Desk-Mounted Cat Bed 76 — clamp-mount 360° perch beside monitor; 2 brands converged Mar-May 2026 (Desk Nest $159 "original"+media; Ergo Purrch 96 rev 4.9★); cats PERCH on desk → novel desk-specific object; strong cat-UGC + WFH cat-parent emotion |
↳ Noise Type: journaling-supplies store matched on "desk" (Desk Cosmos) | cat pharma story-spam ("STOP THE LICKING") | DramaWave mini-drama spam ×2 | POD figurines (My Mini Mento) | desk cat-figurine novelty (below floor) | ↳ Emotional Cluster: cat-companionship at work / "cat steals my workspace" | ↳ Signal Density: Medium (~8% — desk-mounted cat bed sub-category) | ↳ Recurring Categories: desk-mounted clamp cat bed (Desk Nest + Ergo Purrch = convergence), desk cat figurines
| Office×Pet | dog under desk | S30 | 500 | ❌ DEAD | Mirror-test FAIL vs "cat on desk": dogs LIE on floor → only generic dog-bed (not desk-tied) + pet services + POD + spam; NO desk-specific dog object exists; 0. Key learning: animal's physical behavior (perch vs lie) determines whether a desk-specific product exists |
↳ Noise Type: pet services (daycare/vet/K9 hotel/apartments-with-dog-spa) | POD personalized (Pawfect House desk mat/My Mini Mento) | desk novelty (Atomic clock/Definitein bulldog pots) | pet-health & grief story-spam | merch (Lofi/Scholastic/Custom Ink) | ↳ Emotional Cluster: dog-companionship at work | ↳ Signal Density: Very Low (<2% white-label) | ↳ Recurring Categories: generic dog beds (not desk-tied), POD pet-lover mats, pet daycare/boarding services

| Worker Pain/Condition | hands cracked from work | S31 | 202 | ❌ DEAD | "cracked hands" → hand balm/salve/lotion-bar = consumable skincare commodity (Kobee's $40 handmade artisan multi-product, MadeOn hardlotion bar, Smooche cloaked-affiliate to cosmetics) ≤floor/non-white-label; no gadget; 0 |
↳ Noise Type: pharma "doctor-story" NO-DOMAIN spam (BP/cholesterol/Lyrica/hearing/neuropathy/perimenopause) | micro-drama romance story-spam ("Elena's POV" ×3) | local services (windshield/foundation/bedbug/pest) | business-opp/affiliate (Mina Elias/Brandon Henry) | ↳ Emotional Cluster: cracked-skin discomfort / hand-care | ↳ Signal Density: Very Low (<2% white-label) | ↳ Recurring Categories: hand balm/cream/lotion-bar (commodity/artisan), foot-crack creams
| Worker Pain/Condition | working in the cold | S31 | 225 | ❌ DEAD | Ambiguous "cold" → garage/home climate (MRCOOL mini-split)/supplements (×3)/garden irrigation/water bottles/pest; warmth = commodity merino socks (Camel City) + branded jacket (Baerskin) + cozy-wearable blanket (Snee .fun — founder-reject class S4/S10/S24); heated-apparel (gloves/vest/hand-warmers) ABSENT as fresh DTC; Whisper Heat under-desk = dup S19 (Marina-rejected); 0 |
↳ Noise Type: home/garage climate appliance | supplements | garden/landscaping | water bottles | pest control | branded/commodity apparel | ↳ Emotional Cluster: cold discomfort / warmth desire | ↳ Signal Density: Low (~5%, all commodity/branded/founder-reject) | ↳ Recurring Categories: under-desk heater (dup S19), wearable blanket, work socks, tactical jacket
| Worker Pain/Condition | working outside all day | S31 | 245 | ❌ DEAD | Broad-condition phrase → supplements (Lymphoria/Relivex/Aspire/LMNT/liver-cleanse) + pharma (SPRAVATO, Hugterra ×3 cloaked) + medical services + garden (Vego ×2/Blossom/landscaping) + novels + local-biz + ministry; expected sun/cooling outdoor-worker category (neck fan/cooling towel/UV sleeves) ABSENT; only Parcil Safety PPE (niche trade/B2B); 0 |
↳ Noise Type: supplements (heavy) | pharma cloaked-affiliate (Hugterra ×3/SPRAVATO) | medical/health services | garden/landscaping | novels | local business | faith/ministry | ↳ Emotional Cluster: outdoor-labor endurance / general wellness | ↳ Signal Density: Very Low (<2%) | ↳ Recurring Categories: none concrete (sun/cooling absent); supplements, garden products
| Worker Pain/Condition | back pain driving | S31 | 263 | ❌ DEAD | NOT FB-blocked (3-word variant passes — confirms S21→S27/S28 block is term-specific to exact "back pain"); seat cushions (Femzene/Housewor — founder-reject S19 saturated/Amazon$20-35) + multi-product wellness-dropship (posture brace $46.99/neck-traction $49.99/back-stretcher = commodity/пустышка) + pain-пустышки (CALLIXE neck-dup S29/Senzio leg/Infinite Age sciatic) + spine-clinics + car-dealer financing; 0 |
↳ Noise Type: seat cushions (founder-reject) | wellness-dropship devices (posture/traction/stretcher) | пустышка pain-devices (neck/leg/sciatic) | spine/pain medical clinics | car-dealer financing | ↳ Emotional Cluster: sitting/driving lower-back pain | ↳ Signal Density: Low (~8%, all founder-reject or пустышка) | ↳ Recurring Categories: memory-foam/U-shape seat cushion (Femzene/Housewor/Bodiform = convergence but founder-closed S19), posture braces, cervical traction
| Worker Pain/Condition | coffee in the car | S31 | 246 | ❌ DEAD | Situation phrase → COFFEE itself (Intelligentsia capsules/Door County+Nguyen beans/Coffee Machine Depot retailer = consumable/branded) + auto-dealers (Doral VW/River Valley Ford/Gwinnett Honda/Lexus) + travel/tourism boards + real-estate + supplements + seat covers; car-coffee gadget/heated commuter mug/spill-proof travel mug ABSENT (mirrors S25 "mug warmer→CUP not device"); Roar Pedal throttle-tuner $169 off-theme auto-enthusiast; 0 |
↳ Noise Type: coffee consumables/retailers | auto dealerships (heavy) | travel/tourism boards | real-estate | supplements | seat covers | ↳ Emotional Cluster: commute coffee ritual / on-the-go | ↳ Signal Density: Very Low (<2% white-label gadget) | ↳ Recurring Categories: coffee beans/capsules, auto dealers, car seat covers
| Worker Pain/Condition | driving for hours | S31 | 295 | ❌ DEAD | Mirrors "back pain driving": trucking/CDL job recruitment (Kaiser/Nagle/Pkg Express) + auto-enthusiast mods/car-care (AvalonKing/MaxSpeeding/DPF-delete/eFlexFuel/Drive Lab) + pharma (VYALEV/ZURZUVAE/Hugterra ×2) + supplements + train/air travel + seat cushions (3rd brand Bodiform U-shape — founder-reject) + work-shoes (Snibbs); 0 |
↳ Noise Type: trucking/CDL job recruitment | auto-enthusiast mods/car-care | pharma cloaked | supplements | train/air travel services | seat cushions (founder-reject) | work footwear | ↳ Emotional Cluster: long-haul driving fatigue/back pain | ↳ Signal Density: Low (~6%, founder-reject/commodity) | ↳ Recurring Categories: seat cushion (Bodiform/Femzene/Housewor convergence — founder-closed), trucking jobs, auto mods
| Worker Pain/Condition | losing your voice | S31 | 238 | ❌ DEAD | Cosmetics (Rise Luxus foundation) + decor (Stone Bridge frames) + apps/B2B (songwriting app/agentic-commerce/voice-search SEO) + story-spam (cat-food/hair); only on-theme physical = Loudcup horn-tumbler (loudcup.com, sports-parent noisemaker, viral TikTok) but patent-pending/branded (NOT white-label) + novelty-seasonal + ~58; teacher voice-amplifier/throat-spray/lozenge ABSENT as fresh DTC; 0 |
↳ Noise Type: cosmetics | decor/frames | apps/B2B (songwriting/agentic-commerce/SEO) | cat-food & hair story-spam | ↳ Emotional Cluster: voice-loss (cheering/teaching) | ↳ Signal Density: Very Low (<2% white-label) | ↳ Recurring Categories: none white-label (Loudcup = patent-pending branded novelty)
