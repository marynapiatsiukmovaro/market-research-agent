...
## Scoring Calibration (use to stay consistent across sessions)

### Problem-Solving (20)
- **16–20:** Solves a frequent, painful, obvious problem. Solution is immediately clear.
- **8–15:** Solves a real problem but it's niche or requires some explanation.
- **0–7:** Nice-to-have, no clear pain point, or problem is too abstract.

### Wow-Effect / Scroll-Stopping (20)
- **16–20:** Value visually obvious within 1–3 seconds. Creates immediate curiosity or reaction. Easy to demonstrate in short video. Viewer thinks "what is that?" or "I need this."
...
- **2–3:** Manageable but some complexity (size, fragility).
- **0–1:** Heavy, fragile, regulated, or cold chain required.

### UGC Potential (5)
- **4–5:** Easy to film, visible transformation, reaction-worthy, natural lifestyle fit.
