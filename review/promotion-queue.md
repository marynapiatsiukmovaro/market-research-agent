...
**Affected file(s):** core/identity.md (Output Format section)
...
**Affected file(s):** departments/facebook-ads-library/workflow.md (round protocol)
**Confidence:** High — прямой фидбек от Марины, Session 4
**Recommendation:** Promote
...
**Affected file(s):** core/mandatory-filters.md (price ceiling rule) + core/scoring-system.md (Margin Potential calibration)
...
**Affected file(s):** departments/facebook-ads-library/workflow.md (STEP 1 — Scan Sources), shared/sources-overview.md
