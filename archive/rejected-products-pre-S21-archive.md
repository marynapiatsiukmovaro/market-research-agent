# ARCHIVED — Rejected-products, Sessions 3–20 (closed-era negative intelligence)

**Archived:** 2026-05-24 (Session 30 cleanup) from `shared/rejected-products.md`.
**Reason:** These detailed rejection logs + pattern summaries cover CLOSED hypotheses / inactive
verticals (beauty devices, travel, pet-tech, home/kitchen, kids, broad-performance keywords).
Preserved as negative-intelligence / "already-explored-territory" reference and duplicate-prevention.
Active-era anti-patterns (Session 24+) remain in the live rejected-products.md. Nothing deleted.
